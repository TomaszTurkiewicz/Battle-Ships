...
public class ShipGreyHiddenBackground extends Drawable {

    private Context context;
    private final Paint paint;
    private final int square;

    public ShipGreyHiddenBackground(Context context, int square){
        this.square=square;
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        paint.setStrokeWidth(square/10);
        paint.setColor(ContextCompat.getColor(context, R.color.widmoShip));
